...
export default function FlashDealItem() {
    return (
        <div className="bg-white flex items-center rounded-lg group overflow-hidden border border-transparent hover:border-primary duration-300">
            <div className="relative overflow-hidden">
                <Image
                    ...
                    width={400}
                    height={400}
                    className="w-80 h-full object-cover group-hover:scale-120 duration-300"
                />
